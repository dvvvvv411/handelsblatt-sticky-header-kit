    ...
    { 
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
          ...
          <path fill="currentColor" fillRule="evenodd" d="M16.622 11.304C13.23 9.274 9.092 9.831 7.46 10.367C7.198 10.454 6.915 10.311 6.829 10.049C6.743 9.786 6.886 9.504 7.148 9.417C8.93 8.832 13.4 8.211 17.136 10.446C17.373 10.588 17.45 10.895 17.308 11.132C17.166 11.369 16.859 11.446 16.622 11.304ZM11.222 14.331C9.964 14.288 8.8 14.525 8.13 14.752C7.868 14.84 7.584 14.699 7.496 14.438C7.408 14.176 7.548 13.892 7.81 13.804C8.584 13.543 9.868 13.284 11.256 13.332C12.644 13.381 14.189 13.739 15.424 14.771C15.636 14.948 15.664 15.264 15.487 15.476C15.31 15.687 14.994 15.716 14.782 15.538C13.778 14.699 12.48 14.375 11.222 14.331ZM11.288 12.157C9.849 12.108 8.578 12.399 7.868 12.672C7.61 12.771 7.321 12.642 7.222 12.384C7.123 12.126 7.252 11.837 7.509 11.738C8.34 11.419 9.744 11.104 11.322 11.157C12.905 11.211 14.695 11.637 16.254 12.839C16.473 13.008 16.514 13.322 16.345 13.541C16.176 13.759 15.862 13.8 15.644 13.631C14.293 12.59 12.723 12.205 11.288 12.157Z" clipRule="evenodd" />
        </svg>
      )
    },
    { 
          ...
          <div className="flex flex-wrap gap-4">
            {socialLinks.map((social, index) => (
              <a
                key={index}
                href={social.href}
                className="flex items-center justify-center w-12 h-12 rounded-full border border-gray-600 text-white hover:bg-gray-700 hover:border-gray-500 transition-colors"
                title={social.title}
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="text-white text-sm">
            ...
            <p className="mt-2 text-gray-400">
              Ein Unternehmen der{' '}
              <a 
                href="https://www.holtzbrinck.com" 
          ...
          <div className="flex flex-col sm:flex-row gap-3 min-w-0 md:min-w-[300px]">
            <input
              ...
              className="flex-1 px-4 py-2 bg-gray-700 border border-gray-600 rounded text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm"
              disabled
            />
            <button
              className="px-6 py-2 text-white rounded font-medium hover:opacity-90 transition-colors text-sm whitespace-nowrap"
...
export default HandelsblattFooterH2;