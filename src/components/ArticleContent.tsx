...
const ArticleContent = () => {
  return (
    ...
    >
      <h2 className="text-lg md:text-xl lg:text-2xl font-semibold mb-4 mt-6 font-druk-normal leading-tight" style={{ color: '#1a202c' }}>
        Bitcoin durchbricht historische 100.000-Dollar-Marke
      </h2>

      <p className="mb-4 md:mb-6 font-classic-grotesque text-base md:text-lg leading-relaxed">
